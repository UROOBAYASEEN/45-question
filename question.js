...
var personalname = "urooba";
console.log("hello ".concat(personalname, " would you like to learn some typescript today??"));
/*
...
Question 5: Famous Quote 2: Repeat Exercise 1,
 ...
 Print your message.
 */
var famous_person = "PROPHET PBUH ";
console.log(" ".concat(famous_person, " once said \" all muslim are brother to each other no one have superior to other\""));
/*
 ...
 */
var favroutnumber = 8;
console.log("my favriout number is ".concat(favroutnumber));
/*
...
var message = "learn typescript and working hard for bright future";
/*
...
var friendlist = ["naziya", "tanzeela", "maryam", "fatima", "amina", "uroosa"];
...
for (var _i = 0, friendlist_1 = friendlist; _i < friendlist_1.length; _i++) {
    var people = friendlist_1[_i];
    console.log("hy ".concat(people, " how are you?"));
}
...
var transportmode = ["car", "honda", "ode", "farari", "pajaro"];
for (var i_1 = 0; i_1 <= transportmode.length; i_1++) {
    console.log("I WOULD LIKE TO TRAVEL IN ".concat(transportmode[i_1]));
}
...
var guestlist = ['rafia', 'sajida', 'tasleem'];
guestlist.forEach(function (guest) {
    console.log("HY ".concat(guest, " I INVITE YOU IN DINNER "));
});
/*
...
console.log(guestlist);
guestlist.forEach(function (guest1) {
    console.log("DEAR ".concat(guest1, " you are invite in dinner"));
});
/*
...
var finnalguest = guestlist.slice(0, 2);
console.log(finnalguest);
finnalguest.forEach(function (person) {
    console.log("DEAR ".concat(person, " you are invite in dinner "));
});
/*

 Question 18: Seeing the World: Think of at least five places you’d like to visit. */
var places = ["japan", "america", "MALDIVE", "tuekey", "ISTAMBUL"];
//places.reverse()
console.log(places);
...
console.log("I AM INVITING ".concat(guestlist.length, " person in dinner"));
/*
...
var beautifullplace = ['naran', 'kaghan', 'muree', 'islamabad'];
console.log("I WOULD LIKE TO VISIT ".concat(beautifullplace));
/*
...
console.log("my name is ".concat(myself.name, " i am countine our education at ").concat(myself.class, " and my nationality is ").concat(myself.nationality));
/*
...
var childen = ['samama', 'sufyan', 'tuba', 'khansa', 'hamza'];
...
*/
var fruit = ['apple', 'orange', 'mango', 'banana', 'litchi'];
...
fruit.forEach(function (things) {
    if (things == "mango") {
        console.log("i like mango in summer");
    }
    else {
        console.log("i like  ".concat(things, " in daily morning"));
    }
});
/*
...
var new_users = ["admin", "uSer1", "User3", "teacher", "principal", "sir", "fbuser"];
new_users.forEach(function (user) {
    var newuser = user.toLowerCase();
    var username = current_users.some(function (current_user) {
        current_user.toLowerCase() === newuser; // ture  false 
    });
    if (username) {
        console.log("".concat(newuser, " avalible"));
    }
    else {
        console.log("".concat(newuser, "is not avaible"));
...
for (i = 0; i < 10; i++) {
    ...
    console.log("".concat(i).concat(output));
}
/*
...
pizza.    */
var Pizzas = ["chiken pizza", "californa pizza", "chez pizza"];
Pizzas.forEach(function (piza) {
    console.log("I VERY WANT TO EAT ".concat(piza));
});
/*
...
animal.forEach(function (val) {
    console.log("".concat(val, " is also in home"));
    console.log("".concat(val, " is home pet"));
});
console.log("these animal are  present in all home almost ");
/*
question number 36   */
function make_shirt(size, print) {
    console.log("the  shirt size is ".concat(size, "  and in shirt print  ").concat(print));
}
...
function made_shirt(size, message) {
    ...
    if (message === void 0) { message = "i love shirts "; }
    console.log("my shirt size is ".concat(size, " and messege is ").concat(message));
}
...
function make_album(name, tittle, tracks) {
    var album = { name: name, tittle: tittle };
    if (tracks) {
        album["tracks"] = tracks;
    }
    return album;
...
question no 41
*/
var magician = ["alian", "draval", "aleees"];
function show_magic(magician) {
    magician.forEach(function (person) {
        console.log(person);
        console.log(" ".concat(person, " show magic"));
    });
}
show_magic(magician);
/*
...
function make_great(magician) {
    for (var i_2 = 0; i_2 < magician.length; i_2++) {
        console.log("".concat(magician[i_2], " the great "));
    }
}
make_great(magician);
/*
...
*/
var magician2 = ["alian", "draval", "aleees"];
var newarry = __spreadArray([], magician2, true);
var withgreeting = "";
function show_megacians(great) {
    for (var _i = 0, newarry_1 = newarry; _i < newarry_1.length; _i++) {
        var val = newarry_1[_i];
        withgreeting += "".concat(great, " ").concat(val, "\n ");
    }
    return withgreeting;
}
var mygreeting = show_megacians("hello");
var makearry = mygreeting.split("\n");
...
function mysandwich() {
    ...
    console.log("this is always inculde in sandwich ".concat(items));
}
var burgur1 = mysandwich("cheez", "egg", "bun");
var burger2 = mysandwich("salt", "souses", "kachap");
/*
question no 45
*/
...
var car1 = cardetails("toyotta", "carotalla", ["red", "black"], ["year", 2024]);
var car2 = cardetails("honda", "farari", ["black", "gry"], ["year", 2024]);
console.log(car1);
console.log(car2);
